...
import { SingleMovieDiv } from "../styled-components/sectionsStyles";
import { AppDispatch, RootState } from "../store";
import { changeBookmarks } from "../features/accountSlice";
import { ImageHover } from "../styled-components/elementsStyles";
import PlayImage from "/images/icon-play.svg"

export default function SingleMovie({name}: {
    name: string,
}) {
    ...
    return (
        <SingleMovieDiv>
            <ImageHover>
                <img src={object?.thumbnail.regular.small} alt="movie image" className="md:hidden w-[100%] rounded-[8px] mb-[8px]"/>
                <img src={object?.thumbnail.regular.medium} alt="movie image" className="hidden md:block lg:hidden w-[100%] rounded-[8px] mb-[8px]"/>
                <img src={object?.thumbnail.regular.large} alt="movie image" className="hidden lg:block w-[100%] rounded-[8px] mb-[8px]"/>
                <div className="play">
