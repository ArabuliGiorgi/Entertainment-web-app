      ...
      <div className="md:p-[24px] md:pb-0 lg:h-[100%] lg:p-[32px] lg:pr-[36px]">
        <Header>
          ...
          <div className="list">
            ...
            <svg viewBox="0 0 17 20" xmlns="http://www.w3.org/2000/svg" onClick={() => setList("bookmarks")} className={`cursor-pointer ${list === "bookmarks" ? 'fill-[#FFFFFF]' : 'fill-[#5A698F] lg:hover:fill-[#FC4747]'}`}>
